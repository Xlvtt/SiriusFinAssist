...
Ответ: Нa отели вами было потрачено <N> рублей.
...
additional_instructions = '''Если речь идёт o расходах, то не используй минус при ответе.
...
assistant = AssistantAgent("assistant", llm_config=llm_config, 
                           system_message='''Ты профессиональный финансовый ассистент.
Ты создан отвечать на вопросы пользователей o их финансах, быть полезным.
Действуй по следующему плану:
1. Посмотри информацию o базе данных
