...
class Bot:
    ...
    def get(self, message: str):
        ...
        params = 'Годовой доход 1200000р, траты в месяц на жилье 50000р, затраты на все остальное дают возможность откладывать средства по 5000 в месяц. Из этой информации говори только необходимую информацию и ничего лишне'
